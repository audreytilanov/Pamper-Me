...
<div class="xl:px-[80px] px-[24px] py-[64px] flex flex-col items-center md:gap-[24px] gap-[16px] bg-pattern">
    ...
    <div class="flex flex-col items-center gap-[8px] text-center md:text-start bg-white shadow-md px-[16px] py-[8px] rounded-md">
        <h1 class="md:text-xl text-base text-pink-500 font-bold">Silahkan tunjukkan barcode ini kepada pegawai</h1>
        <h1 class="md:text-xl text-base text-pink-500 font-bold">Note : Jangan di scan jika layanan belum dilakukan</h1>
    </div>
</div>
<!-- End User Dashboard -->
