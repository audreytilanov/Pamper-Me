<form action="javascript:void(0)" id="dataDetail" method="POST">
    ...
    <div class="card-body">
        ...
        <div class="form-group form-group-default layananShow col-md-4">
        ...
        <div class="form-group form-group-default kategoriShow col-md-4">
        ...
        <div class="form-group form-group-default produkShow col-md-4">
        ...
        <div class="form-group form-group-default jamShow col-md-4">
