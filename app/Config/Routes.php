...
$routes->group('user', ['filter' => 'auth'], static function ($routes) {
    ...
    $routes->post('data-anak/edit/(:segment)', 'DataAnak::update/$1', ['as' => 'user.dasdasdasdasdasdasd.dasdasd']);
...
$routes->group('admin',['filter' => 'adminauth'], static function ($routes) {
    ...
    $routes->get('reservasi/cari/cabangInput', 'AdminReservasi::reservasiCabangInput',['as' => 'admin.reservasi.cabangInput']);
